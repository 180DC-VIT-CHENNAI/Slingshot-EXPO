  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: hit ? "rgba(0,0,0,0.55)" : "rgba(0,0,0,0.75)",
      ...
      >
        <div className="glass-card p-7 text-center">
          <div className="text-5xl mb-2 animate-count-bounce">
            {hit ? "🎯" : "💨"}
          </div>
          ...
          {showMessage && (
            <div className="mb-2 mt-2">
              ...
              >
                <p
                  className={`font-display font-semibold text-sm leading-snug ${hit ? "text-white" : "text-white/70"}`}
            ...
            <div className="mb-1">
              ...
              >
                <span
                  ...
                  style={{
                    color: "#7CFC00",
                    textShadow: "0 0 12px rgba(124,252,0,0.4)",
                  }}
                >
                  +{countUpScore}
                </span>
                <span className="font-display text-xs text-white/50 ml-2 uppercase tracking-wider">
                  score
                </span>
              </div>
            </div>
          ...
          {showButtons && (
            <div className="grid grid-cols-2 gap-x-3 gap-y-1 mt-3 text-xs text-white/40 font-display">
              ...
              <span>Rank</span>
              <span className="text-right text-180dc-green-neon font-bold">
                {rank}
              </span>
            </div>
          )}
          ...
          {showButtons && (
            <div className="space-y-2 mt-2 animate-slide-in-up">
              ...
              {onPlayAgain && (
                <button
                  onClick={onPlayAgain}
                  className={`w-full text-sm py-3 rounded-xl font-display font-bold transition-all ${hit ? "btn-secondary" : "btn-primary"}`}
                >
              ...
              {onBackToCampaign && (
                <button
                  ...
                  className="w-full text-white/40 text-xs text-center hover:text-white/70 transition-colors py-1.5 font-display"
                >
                  Back to Campaign
                </button>
              )}
